...
from nets.unet import U_Net,Unet2
...
if __name__ == "__main__":
    ...
    model = Unet2(num_classes=num_classes, pretrained=pretrained, backbone=backbone).train()
    # model = U_Net(img_ch=3, num_classes=num_classes).train()
